...
print('after imput you will get :')
print('1) matrix of ways ')
print('2) the table with edges and vertex')
print('3) the first string ')
print('4) its derivation table ')
print('5) its derivation tree ')
print('!!! in order to see te next string , just close the tab with plot !!!')
